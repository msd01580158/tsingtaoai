...
from rslstudio.config import CONFIG_PATH
...
from rslstudio.errors import NotAuthenticated
...
CLI_VERSION_HEADER = "RslStudio-Client-Version"
...
class AuthenticatedClient(httpx.Client):
    ...
    def _send_request_with_rslstudio_headers(self, *args: Any, **kwargs: Any) -> httpx.Response:
        ...
        if response.status_code == 426:
            raise rslstudio.errors.UpdateCLIVersion
        return response
    ...
    def request(
        ...
        **kwargs: Any,
        ...
        response = self._send_request_with_rslstudio_headers(method, full_url, params=httpx_params, *args, **kwargs)
